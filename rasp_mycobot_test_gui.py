...
class MycobotTest(object):
    def __init__(self):
        ...
        self.calibration_label = tkinter.Label(self.win, text="Calibrating Servos: ")
        ...
        # LED.
        self.set_color_label = tkinter.Label(self.win, text="Test Light Board：")
        ...
        self.start_btn = tkinter.Button(
            self.win, text="Begin", command=self.start_aging_test
        )
    ...
    def connect_mycobot(self):
        ...
        if not port:
            self.write_log_to_Text("Select serial port")
            return
        self.baud = baud = self.baud_list.get()
        if not baud:
            self.write_log_to_Text("Select baud rate")
            return
        baud = int(baud)
    ...
    def disconnect_mycobot(self):
        ...
        try:
            del self.mycobot
            self.mycobot = None
            self.write_log_to_Text("Successful disconnection !")
        except AttributeError:
            self.write_log_to_Text("MyCobot not connected yet！！！")
